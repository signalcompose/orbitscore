...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1780-1803
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:216-230
        walk(full)
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:211-215
...
- `rust/crates/orbit-audio-daemon/src/outproc_instrument.rs:233-235` — `post_peak_bits` (lock-free peak accumulation implementation)
