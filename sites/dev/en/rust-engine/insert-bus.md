...
```rust
// rust/crates/orbit-audio-native/src/output.rs:377-396
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:721-726
    if sources.is_empty() {
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:837-843
