...
```rust
// rust/crates/orbit-audio-native/src/output.rs:703-722
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1048-1053
    if sources.is_empty() {
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1164-1170
