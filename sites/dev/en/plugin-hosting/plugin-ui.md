...
```rust
// rust/crates/orbit-audio-daemon/src/session/dispatch.rs:317-318
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap/wire_types.rs:56-69
...
```typescript
// packages/vscode-extension/src/extension.ts:1069-1073
