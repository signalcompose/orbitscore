...
```typescript
// packages/vscode-extension/src/extension.ts:2406-2417
...
```typescript
// packages/vscode-extension/src/extension.ts:2424-2426
...
```typescript
// packages/vscode-extension/src/extension.ts:2427-2476 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2476-2499
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2504-2561
...
```typescript
// packages/vscode-extension/src/extension.ts:2773-2782
...
```typescript
// packages/vscode-extension/src/extension.ts:3670-3744
...
```typescript
// packages/vscode-extension/src/extension.ts:3746-3757
...
```typescript
// packages/vscode-extension/src/extension.ts:3800-3817
