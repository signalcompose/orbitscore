...
```typescript
// packages/vscode-extension/src/extension.ts:2419-2430
...
```typescript
// packages/vscode-extension/src/extension.ts:2437-2439
...
```typescript
// packages/vscode-extension/src/extension.ts:2440-2489 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2489-2512
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2517-2574
...
```typescript
// packages/vscode-extension/src/extension.ts:2786-2795
...
```typescript
// packages/vscode-extension/src/extension.ts:3683-3757
...
```typescript
// packages/vscode-extension/src/extension.ts:3759-3770
...
```typescript
// packages/vscode-extension/src/extension.ts:3813-3830
