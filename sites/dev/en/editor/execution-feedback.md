...
```typescript
// packages/vscode-extension/src/extension.ts:2815-2826
...
```typescript
// packages/vscode-extension/src/extension.ts:2833-2835
...
```typescript
// packages/vscode-extension/src/extension.ts:2836-2885 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2800-2813
...
```typescript
// packages/vscode-extension/src/extension.ts:2885-2908
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2972-2979
...
```typescript
// packages/vscode-extension/src/extension.ts:2913-2970
