...
```typescript
// packages/vscode-extension/src/extension.ts:2433-2444
...
```typescript
// packages/vscode-extension/src/extension.ts:2451-2453
...
```typescript
// packages/vscode-extension/src/extension.ts:2454-2503 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2503-2526
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2531-2588
...
```typescript
// packages/vscode-extension/src/extension.ts:2800-2809
...
```typescript
// packages/vscode-extension/src/extension.ts:3697-3771
...
```typescript
// packages/vscode-extension/src/extension.ts:3773-3784
...
```typescript
// packages/engine/src/core/sequence.ts:107-110
...
```typescript
// packages/vscode-extension/src/extension.ts:3827-3844
