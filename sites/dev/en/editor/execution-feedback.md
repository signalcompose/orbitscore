...
```typescript
// packages/vscode-extension/src/extension.ts:2418-2429
...
```typescript
// packages/vscode-extension/src/extension.ts:2436-2438
...
```typescript
// packages/vscode-extension/src/extension.ts:2439-2488 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2488-2511
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2516-2573
...
```typescript
// packages/vscode-extension/src/extension.ts:2785-2794
...
```typescript
// packages/vscode-extension/src/extension.ts:3682-3756
...
```typescript
// packages/vscode-extension/src/extension.ts:3758-3769
...
```typescript
// packages/vscode-extension/src/extension.ts:3812-3829
