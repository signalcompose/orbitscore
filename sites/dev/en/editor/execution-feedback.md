...
```typescript
// packages/vscode-extension/src/extension.ts:2426-2437
...
```typescript
// packages/vscode-extension/src/extension.ts:2444-2446
...
```typescript
// packages/vscode-extension/src/extension.ts:2447-2496 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2496-2519
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2524-2581
...
```typescript
// packages/vscode-extension/src/extension.ts:2793-2802
...
```typescript
// packages/vscode-extension/src/extension.ts:3690-3764
...
```typescript
// packages/vscode-extension/src/extension.ts:3766-3777
...
```typescript
// packages/vscode-extension/src/extension.ts:3820-3837
