...
- **Part VII. SuperCollider Path (removed in #502)** — historical reading of the former default path, reachable with `ORBITSCORE_ENGINE=sc` (acting on the 2026-09-10 ruling #827 / #502, [#840](https://github.com/signalcompose/orbitscore/pull/840) removed the code itself from the repository)
