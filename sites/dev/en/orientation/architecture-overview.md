...
```typescript
// packages/vscode-extension/src/extension.ts:2122-2125
...
```typescript
// packages/vscode-extension/src/extension.ts:2147-2156
...
```typescript
// packages/vscode-extension/src/extension.ts:2211-2224
  if (engineKind === 'rust') {
...
```typescript
// packages/vscode-extension/src/extension.ts:2226-2232
...
```typescript
// packages/vscode-extension/src/extension.ts:3118-3119
