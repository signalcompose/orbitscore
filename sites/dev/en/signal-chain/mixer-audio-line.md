...
- `docs/core/INSTRUCTION_ORBITSCORE_DSL.md:1667-1757` — Mixer / Routing (MX.1–MX.5) normative text
- `docs/core/INSTRUCTION_ORBITSCORE_DSL.md:1298-1300` — known constraint: master gain ramp applied before the insert
