...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1469-1485
  scheduleEvent(
    filepath: string,
    time: number,
    gainDb = 0,
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1624-1630
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1537-1554
  start(): void {
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1786-1792
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1601-1609
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1656-1700
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1632-1648
  /**
...
```typescript
// packages/engine/src/audio/rust-engine/rust-engine-player.ts:1556-1583
  stop(): void {
    if (this.intervalId) {
