...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap/outproc_effect_slots.rs:215-237
        let mut route = {
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:5080-5087
...
- `.github/workflows/release.yml:98-104,190-199` — 実 Gain テストと `.vsix` 内の同梱ゲート
