...
- `rust/crates/orbit-audio-daemon/src/outproc_instrument.rs:218-220` — `post_peak_bits`（lock-free peak 累積の実装）
...
- `tests/e2e/orbitstudio-mcp-gated.spec.ts:80-155` — stale artifact ガード（`assertDaemonBinaryIsNotStale`）
