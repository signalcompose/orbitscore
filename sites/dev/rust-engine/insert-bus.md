...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1252-1271
...
#611 PR-O3a（[#810](https://github.com/signalcompose/orbitscore/pull/810)）で、この 4 つは
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1723-1728
    if sources.is_empty() {
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1927-1933
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap.rs:2017-2025
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap.rs:2049-2061
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap.rs:2139-2161
