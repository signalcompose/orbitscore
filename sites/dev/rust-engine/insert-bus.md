...
```rust
// rust/crates/orbit-audio-native/src/output.rs:693-712
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1038-1043
    if sources.is_empty() {
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:1154-1160
