...
```rust
// rust/crates/orbit-audio-native/src/output.rs:470-489
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:877-882
    if sources.is_empty() {
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:993-999
