...
```rust
// rust/crates/orbit-audio-native/src/output.rs:454-473
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:848-853
    if sources.is_empty() {
...
```rust
// rust/crates/orbit-audio-native/src/output.rs:964-970
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap.rs:1933-1941
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap.rs:1965-1977
...
```rust
// rust/crates/orbit-audio-daemon/src/engine_wrap.rs:2055-2077
