...
```typescript
// packages/vscode-extension/src/extension.ts:2114-2117
...
```typescript
// packages/vscode-extension/src/extension.ts:2139-2148
...
```typescript
// packages/vscode-extension/src/extension.ts:2203-2216
  if (engineKind === 'rust') {
...
```typescript
// packages/vscode-extension/src/extension.ts:2218-2224
...
```typescript
// packages/vscode-extension/src/extension.ts:3110-3111
