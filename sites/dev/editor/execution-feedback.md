...
```typescript
// packages/vscode-extension/src/extension.ts:2778-2789
...
```typescript
// packages/vscode-extension/src/extension.ts:2796-2798
...
```typescript
// packages/vscode-extension/src/extension.ts:2799-2848 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2763-2776
...
```typescript
// packages/vscode-extension/src/extension.ts:2848-2871
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2935-2942
...
```typescript
// packages/vscode-extension/src/extension.ts:2876-2933
...
```typescript
// packages/vscode-extension/src/extension.ts:3139-3148
...
```typescript
// packages/vscode-extension/src/extension.ts:4071-4145
...
```typescript
// packages/vscode-extension/src/extension.ts:4147-4158
...
```typescript
// packages/vscode-extension/src/extension.ts:4201-4218
