...
```typescript
// packages/vscode-extension/src/extension.ts:2786-2797
...
```typescript
// packages/vscode-extension/src/extension.ts:2804-2806
...
```typescript
// packages/vscode-extension/src/extension.ts:2807-2856 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2771-2784
...
```typescript
// packages/vscode-extension/src/extension.ts:2856-2879
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:3088-3120
...
```typescript
// packages/vscode-extension/src/extension.ts:2943-2950
...
```typescript
// packages/vscode-extension/src/extension.ts:2884-2941
...
```typescript
// packages/vscode-extension/src/extension.ts:3147-3156
...
```typescript
// packages/vscode-extension/src/extension.ts:4079-4153
...
```typescript
// packages/vscode-extension/src/extension.ts:4155-4166
...
```typescript
// packages/vscode-extension/src/extension.ts:4209-4226
