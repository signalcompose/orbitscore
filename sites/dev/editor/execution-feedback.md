...
```typescript
// packages/vscode-extension/src/extension.ts:2775-2786
...
```typescript
// packages/vscode-extension/src/extension.ts:2793-2795
...
```typescript
// packages/vscode-extension/src/extension.ts:2796-2845 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2760-2773
...
```typescript
// packages/vscode-extension/src/extension.ts:2845-2868
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:3077-3109
...
```typescript
// packages/vscode-extension/src/extension.ts:2932-2939
...
```typescript
// packages/vscode-extension/src/extension.ts:2873-2930
...
```typescript
// packages/vscode-extension/src/extension.ts:3136-3145
...
```typescript
// packages/vscode-extension/src/extension.ts:4068-4142
...
```typescript
// packages/vscode-extension/src/extension.ts:4144-4155
...
```typescript
// packages/vscode-extension/src/extension.ts:4198-4215
