...
```typescript
// packages/vscode-extension/src/extension.ts:2792-2803
...
```typescript
// packages/vscode-extension/src/extension.ts:2810-2812
...
```typescript
// packages/vscode-extension/src/extension.ts:2813-2862 (setDocumentDirectory 注入前まで)
  } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2777-2790
...
```typescript
// packages/vscode-extension/src/extension.ts:2862-2885
    } else {
...
```typescript
// packages/vscode-extension/src/extension.ts:2949-2956
...
```typescript
// packages/vscode-extension/src/extension.ts:2890-2947
...
```typescript
// packages/vscode-extension/src/extension.ts:3153-3162
...
```typescript
// packages/vscode-extension/src/extension.ts:4085-4159
...
```typescript
// packages/vscode-extension/src/extension.ts:4161-4172
...
```typescript
// packages/vscode-extension/src/extension.ts:4215-4232
