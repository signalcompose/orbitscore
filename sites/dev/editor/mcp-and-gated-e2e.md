...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:71-77
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:163-173
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:152-154
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:256-262
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:600-605
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2054-2064
      const dslLines = [
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2067-2068
      const start = await activeClient.call('start_engine', { debug: true })
      expect(start.isError, start.text).toBe(false)
```

```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2124-2126
