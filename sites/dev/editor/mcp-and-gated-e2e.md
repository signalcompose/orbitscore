...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:63-69
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:155-165
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:144-146
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:727-748
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:248-254
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:865-870
...
```typescript
// tests/e2e/helpers/run-score.ts:211-223
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:1406-1420
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:589-594
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2043-2053
      const dslLines = [
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2056-2057
      const start = await activeClient.call('start_engine', { debug: true })
      expect(start.isError, start.text).toBe(false)
```

```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2113-2115
