...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:152-162
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:725-746
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:245-251
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:863-868
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:1404-1418
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2041-2051
      const dslLines = [
...
```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2054-2055
      const start = await activeClient.call('start_engine', { debug: true })
      expect(start.isError, start.text).toBe(false)
```

```typescript
// tests/e2e/orbitstudio-mcp-gated.spec.ts:2111-2113
