...
```typescript
// packages/vscode-extension/src/extension.ts:1985-2008
  // Set environment
  const env = { ...process.env }
  if (effectiveDebugMode) {
    env.ORBITSCORE_DEBUG = '1'
...
```typescript
// packages/vscode-extension/src/extension.ts:2023-2034
  // Setup handlers
...
```typescript
// packages/vscode-extension/src/extension.ts:2048-2096
