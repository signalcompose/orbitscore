...
```typescript
// packages/vscode-extension/src/extension.ts:2169-2182
  // Build args
  const args = ['repl']
...
```typescript
// packages/vscode-extension/src/extension.ts:2200-2222
  if (engineKind === 'rust') {
...
```typescript
// packages/vscode-extension/src/extension.ts:2237-2248
  // Setup handlers
...
```typescript
// packages/vscode-extension/src/extension.ts:2262-2310
