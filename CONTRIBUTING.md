...
- **Integration tests**: Test against the real Rust daemon via the gated E2E harness (`npm run test:e2e:gated`) when applicable. The daemon is the only audio backend; the opt-out path to the previous one was removed in #502
