...
pub use transport::{
    ...
    CommandOutcome, SharedRegion, TransportContext, BUF_LEN, CHANNELS, CMD_RESULT_BAD_ARG,
    CMD_RESULT_IO_ERROR, CMD_RESULT_OK, CMD_RESULT_PLUGIN_ERROR, CMD_RESULT_UNKNOWN_KIND,
    CMD_SAVE_STATE, CONTROL_QUIT, CONTROL_RUN, MAX_EVENTS_PER_BLOCK, MAX_FRAMES, REGION_BYTES,
    SLOTS,
};
