...
| コミット | 内容 |
|---|---|
| 0-2 / I-1 / I-2 / III-1〜3 / ADR-002 再検証 | アーキテクチャ全景を 4 層（extension / engine / Rust daemon / plugin children）へ書き直し、pipeline 2 章と SuperCollider 経路 3 章（冒頭 warning で opt-out 経路と明記）、ADR-002 を 69dc968 へ。引用は check-citations で 0 failed（残りの I-3 / IV-1 / IV-2 / ADR-001 / ADR-003 は後続コミット） |
